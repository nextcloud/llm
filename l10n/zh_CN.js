OC.L10N.register(
    ...
    "Could not execute python. You may need to set the path to a working executable manually. (See below.)" : "无法执行 Python。你可能需要手动设置工作可执行文件的路径。(见下文)。",
    ...
    "Could not execute python. You may need to set the path to a working executable manually." : "无法执行 Python。你可能需要手动设置工作可执行文件的路径。",
    "Python executable executed successfully and setup works." : "Python 可执行程序成功执行，设置成功。",
    "If python is not found automatically on your system for some reason you can set the path to the python executable here. If you change this value, make sure to run occ maintenance:repair afterwards." : "如果在你的系统中由于某种原因不能自动找到 python，你可以在这里设置 python 的可执行路径。如果你改变了这个值，请确保之后运行 occ maintenance:pair。",
