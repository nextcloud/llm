OC.L10N.register(
    ...
    "Local GPT4ALL Large language model" : "Lokales GPT4ALL Großes Sprachmodell",
    "TextProcessing provider using a GPT4All Large Language Model by Nomic AI that runs locally on CPU" : "Textverarbeitungsanbieter, der das große Sprachmodell GPT4All von Nomic AI verwendet, das auf dem lokalen Prozessor ausgeführt  wird",
    "A TextProcessing provider using a GPT4All Large Language Model by Nomic AI  that runs locally on CPU\n\nThe models run completely on your machine. No private data leaves your servers.\n\nAfter installing this app you will need to run\n\n    occ llm:download-models\n\nRequirements:\n\n* x86 CPU\n* GNU lib C (musl is not supported)\n* Python 3.10+\n\n## Ethical AI Rating\n### Rating: 🟢\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be ran on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "Ein Anbieter von Textverarbeitung mit einem GPT4All Large Language Model von Nomic AI, das lokal auf der CPU läuft\n\nDie Modelle laufen komplett auf Ihrer Maschine. Keine privaten Daten verlassen Ihre Server.\n\nNach der Installation dieser App müssen Sie Folgendes ausführen\n\n    occ llm:download-models\n\nErfordert:\n\n* x86-CPU\n* GNU lib C (musl wird nicht unterstützt)\n* Python 3.10+\n\n## Ethische KI-Bewertung\n### Bewertung: 🟢\n\nPositiv:\n* Die Software für Training und Inferenz dieses Modells ist Open Source\n* Das trainierte Modell ist frei verfügbar und kann daher vor Ort ausgeführt werden\n* Die Trainingsdaten sind frei verfügbar, so dass eine Überprüfung oder Korrektur von Verzerrungen oder eine Optimierung der Leistung und des CO2-Verbrauchs möglich ist.\n\nErfahren Sie mehr über die ethische KI-Bewertung von Nextcloud [in unserem Blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    "Status" : "Status",
